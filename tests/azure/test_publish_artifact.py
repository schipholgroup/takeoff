...
from takeoff.azure.publish_artifact import lang_must_match_target
...
class TestPublishArtifact(unittest.TestCase):
    ...
    def test_validate_schema_invalid_target(self, _):
        ...
        conf = {**takeoff_config(), **BASE_CONF, **{"lang": "sbt", "target": ["pypi"]}}
    ...
    def test_publish_python_package_blob(self, _, __):
        conf = {**takeoff_config(), **BASE_CONF, "target": ["blob"]}
    ...
    def test_publish_python_package_blob_with_file(self, _, __):
        conf = {**takeoff_config(), **BASE_CONF, "target": ["blob"], "python_file_path": "main.py"}
    ...
    def test_publish_python_package_pypi(self, _, __):
        conf = {**takeoff_config(), **BASE_CONF, "lang": "sbt", "target": ["blob"]}
    ...
    def test_publish_python_package_blob(self, _):
        conf = {**takeoff_config(), **BASE_CONF, "lang": "sbt", "target": ["ivy"]}
    ...
    def test_publish_to_pypi_no_tag(self, _):
        conf = {**takeoff_config(), **BASE_CONF, "lang": "python", "target": ["pypi"]}
    ...
    def test_publish_to_ivy(self, _):
        conf = {**takeoff_config(), **BASE_CONF, "lang": "python", "target": ["pypi"]}
        with mock.patch("takeoff.azure.publish_artifact.run_bash_command") as m:
