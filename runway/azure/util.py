...
def get_resource_group_name(config: dict, env: ApplicationVersion):
    ...
    return config['runway_azure']['resource_group_naming'].format(env=env.environment_lower)
...
def get_keyvault_name(config: dict, env: ApplicationVersion):
    ...
    return config['runway_azure']['keyvault_naming'].format(env=env.environment_lower)
...
def get_cosmos_name(config: dict, env: ApplicationVersion):
    ...
    return config['runway_azure']['cosmos_naming'].format(env=env.environment_lower)
...
def get_eventhub_name(config: dict, env: ApplicationVersion):
    ...
    return config['runway_azure']['eventhub_naming'].format(env=env.environment_lower)
